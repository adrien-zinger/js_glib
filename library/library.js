	...
	player: function(){
        ...
        this.create = function (args) {
			...
			if (!player) {
				...
				player.id = this.name;
				player.style.left = (this.position_cam.x * 20) + "px";
				player.style.top = (this.position_cam.y * 20) + "px";
        ...
        this.play_animation = function(args){
            //TODO: how to do an animation just for nothing? CSS
        };
    },
};